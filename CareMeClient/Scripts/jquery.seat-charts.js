	...
	$.fn.seatCharts = function (setup) {
		...
		var fn       = this,
			...
			settings = {
				...
				naming  : {
					top    : true,
					left   : true,
					getId: function (character, row, column, bookingid) {
					    return bookingid == null ? row + '_' + column : row + '_' + column + "_" + bookingid;
				...
				return function (setup) {
					...
					fn.settings.$node
						.attr({
							...
							focusable      : true,
							tabIndex: -1,
							'data-seatnumber': fn.settings.label,
							'data-bookingid':fn.settings.data.bookingid,
                            'data-groupid': fn.settings.data.groupid,
                            'data-grouptitle': fn.settings.data.grouptitle,
                            'data-userid': fn.settings.data.userid,
                            'data-timeout': fn.settings.data.timeoutsecs,
                            'data-theatreid': fn.settings.data.theatreid,
                            'data-movieid': fn.settings.data.movieid,
                            'data-movietitle': fn.settings.data.movietitle,
                            'data-showtime': fn.settings.data.showtime
                           
						})
						.text(fn.settings.label) //fn.settings.label
		...
		settings.naming.rows = settings.naming.rows || (function(length) {
			...
			for (var i = 1; i <= length; i++) {
			    ...
			    var rowname = "a";
			    if(i == 1){rowname= "A"}
			    else if (i == 2) { rowname = "B" }
			    else if (i == 3) { rowname = "C" }
			    else if (i == 4) { rowname = "D" }
			    else if (i == 5) { rowname = "E" }
			    else if (i == 6) { rowname = "F" }
			    else if (i == 7) { rowname = "G" }
			    else if (i == 8) { rowname = "H" }
			    else if (i == 9) { rowname = "I" }
			    else if (i == 10) { rowname = "J" }
			    else if (i == 11) { rowname = "K" }
			    else if (i == 12) { rowname = "L" }
			    else if (i == 13) { rowname = "M" }
			    else if (i == 14) { rowname = "N" }
			    else if (i == 15) { rowname = "O" }
			    else if (i == 16) { rowname = "P" }
			    else if (i == 17) { rowname = "Q" }
			    else if (i == 18) { rowname = "R" }
			    else if (i == 19) { rowname = "S" }
			    else if (i == 20) { rowname = "T" }
			    else if (i == 21) { rowname = "U" }
			    else if (i == 22) { rowname = "V" }
			    else if (i == 23) { rowname = "W" }
			    else if (i == 24) { rowname = "X" }
			    else if (i == 25) { rowname = "Y" }
			    else if (i == 26) { rowname = "Z" }
			...
			$.each(characters.match(/[a-z_]{1}(\[[0-9a-z_]{0,}(,[0-9a-z_ ]+)?\])?/gi), function (column, characterParams) { 
				...
				$row.append(character != '_' ?
					...
					(function(naming) {
						...
						var id = overrideId ? overrideId : naming.getId(character, naming.rows[row], naming.columns[column], settings.seats[character].bookingid);
